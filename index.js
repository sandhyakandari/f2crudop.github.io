const arr=[{ID:1,name:'Alice',email:'alice@example.com',age:21,gpa:'A',degree:'Btech'},
{ID:2,name:'bob',email:'bob@example.com',age:22,gpa:'B',degree:'MBA'},
{ID:3,name:'charlie',email:'charlie@example.com',age:20,gpa:'C',degree:'Arts'},
];
let idn=3;
